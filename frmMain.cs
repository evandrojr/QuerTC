...
namespace MiniClient
{
	...
	public class frmMain : System.Windows.Forms.Form
    {
        ...
        private TabPage tabRotulos;
        private GroupBox grpBoxLabels;
        private Button btCreateLabel;
        private Button btDeleteLabel;
        private Button btEditLabel;
        private ListBox lstBLabels;
		...
		{			
            ...
            l.Id = "Rango";
            l.MemberLst.Add("evandro.leite@sim.serpro.gov.br");
            l.MemberLst.Add("celson.aquino@sim.serpro.gov.br");
            MiniClient.Label.LabelLst.Add(l);
            LoadLabels();
		}

        void LoadLabels() {
            foreach (MiniClient.Label l in Label.LabelLst) {
                lstBLabels.Items.Add(l.Id);
            }
